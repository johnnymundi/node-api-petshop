...
class Produto {
  ...
  async carregar() {
    const produto = await Tabela.pegarPorId(this.id, this.fornecedor); //chama o findOne do Sequelize e retorna todos o dados a partir do id e fornecedor
